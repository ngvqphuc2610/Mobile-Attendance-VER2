...
class SessionInstanceRepository {
  ...
  Future<Map<String, dynamic>> createSessionInstanceFromPayload(
    ...
    return await SessionInstanceService.createSessionInstanceFromPayload(payload);
  }
  ...
  Future<Map<String, dynamic>> updateSessionInstanceFromPayload(
    ...
    return await SessionInstanceService.updateSessionInstanceFromPayload(id, payload);
  }
